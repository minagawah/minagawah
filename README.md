...
A JS library for calculating the position of the sun which is ported from *[another library of mine](https://github.com/minagawah/sowngwala/)* which is written in Rust.  
