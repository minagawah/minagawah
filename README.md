...
While Worker is a powerful tool, when implementing the related Web APIs, it can easily drive you into a rabbit hole. This sample app attempts to demonstrate how you can implement related APIs for Workers.  
